...
const char *gengetopt_args_info_help[] = {
  ...
  "  -H, --heuristic=STRING        specify heuristics. The first heuristic in the\n                                  list is the one used for search. Starting\n                                  from the second, all other heuristics are\n                                  used as tiebreakers. If you specify the same\n                                  heuristic twice, it will only be computed\n                                  once.  (default=`rc2(ff)')",
  "      --mainHeuristicAsTiebreaker\n                                use the first heuristic as the first\n                                  tie-breaker. The first   (default=off)",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->mainHeuristicAsTiebreaker_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->mainHeuristicAsTiebreaker_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->mainHeuristicAsTiebreaker_help = gengetopt_args_info_help[17] ;
  args_info->astarweight_help = gengetopt_args_info_help[18] ;
  args_info->gValue_help = gengetopt_args_info_help[19] ;
  args_info->suboptimal_help = gengetopt_args_info_help[20] ;
  args_info->noVisitedList_help = gengetopt_args_info_help[22] ;
  args_info->taskHash_help = gengetopt_args_info_help[23] ;
  args_info->taskSequenceHash_help = gengetopt_args_info_help[24] ;
  args_info->topologicalOrdering_help = gengetopt_args_info_help[25] ;
  args_info->noLayers_help = gengetopt_args_info_help[26] ;
  args_info->noOrderPairs_help = gengetopt_args_info_help[27] ;
  args_info->noParallelSequences_help = gengetopt_args_info_help[28] ;
  args_info->noGIcheck_help = gengetopt_args_info_help[29] ;
  args_info->blockcompression_help = gengetopt_args_info_help[31] ;
  args_info->satmutexes_help = gengetopt_args_info_help[32] ;
  args_info->pruning_help = gengetopt_args_info_help[33] ;
  args_info->methodPreconditionsInSeparateLeafs_help = gengetopt_args_info_help[34] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->mainHeuristicAsTiebreaker_given)
    write_into_file(outfile, "mainHeuristicAsTiebreaker", 0, 0 );
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "heuristic",	1, NULL, 'H' },
        { "mainHeuristicAsTiebreaker",	0, NULL, 0 },
      ...
      switch (c)
        ...
        case 'I':	/* interactive search.  */
          ...
          break;
        case 'H':	/* specify heuristics. The first heuristic in the list is the one used for search. Starting from the second, all other heuristics are used as tiebreakers. If you specify the same heuristic twice, it will only be computed once..  */
        ...
        case 0:	/* Long option with no short option */
          ...
          /* use the first heuristic as the first tie-breaker. The first .  */
          else if (strcmp (long_options[option_index].name, "mainHeuristicAsTiebreaker") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->mainHeuristicAsTiebreaker_flag), 0, &(args_info->mainHeuristicAsTiebreaker_given),
                &(local_args_info.mainHeuristicAsTiebreaker_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "mainHeuristicAsTiebreaker", '-',
                additional_error))
              goto failure;
