...
struct gengetopt_args_info
{
  ...
  char ** heuristic_arg;	/**< @brief specify heuristics. The first heuristic in the list is the one used for search. Starting from the second, all other heuristics are used as tiebreakers. If you specify the same heuristic twice, it will only be computed once. (default='rc2(ff)').  */
  char ** heuristic_orig;	/**< @brief specify heuristics. The first heuristic in the list is the one used for search. Starting from the second, all other heuristics are used as tiebreakers. If you specify the same heuristic twice, it will only be computed once. original value given at command line.  */
  unsigned int heuristic_min; /**< @brief specify heuristics. The first heuristic in the list is the one used for search. Starting from the second, all other heuristics are used as tiebreakers. If you specify the same heuristic twice, it will only be computed once.'s minimum occurreces */
  unsigned int heuristic_max; /**< @brief specify heuristics. The first heuristic in the list is the one used for search. Starting from the second, all other heuristics are used as tiebreakers. If you specify the same heuristic twice, it will only be computed once.'s maximum occurreces */
  const char *heuristic_help; /**< @brief specify heuristics. The first heuristic in the list is the one used for search. Starting from the second, all other heuristics are used as tiebreakers. If you specify the same heuristic twice, it will only be computed once. help description.  */
  int mainHeuristicAsTiebreaker_flag;	/**< @brief use the first heuristic as the first tie-breaker. The first  (default=off).  */
  const char *mainHeuristicAsTiebreaker_help; /**< @brief use the first heuristic as the first tie-breaker. The first  help description.  */
  ...
  unsigned int mainHeuristicAsTiebreaker_given ;	/**< @brief Whether mainHeuristicAsTiebreaker was given.  */
